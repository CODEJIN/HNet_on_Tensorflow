...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.structureBPTTInitialReset_Label = QtWidgets.QLabel(self.basicStructureBPTT_Tap)
        self.structureBPTTInitialReset_Label.setGeometry(QtCore.QRect(20, 126, 91, 20))
        self.structureBPTTInitialReset_Label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.structureBPTTInitialReset_Label.setObjectName("structureBPTTInitialReset_Label")
        self.structureBPTTInitialReset_CheckBox = QtWidgets.QCheckBox(self.basicStructureBPTT_Tap)
        self.structureBPTTInitialReset_CheckBox.setGeometry(QtCore.QRect(120, 130, 16, 17))
        self.structureBPTTInitialReset_CheckBox.setText("")
        self.structureBPTTInitialReset_CheckBox.setChecked(True)
        self.structureBPTTInitialReset_CheckBox.setObjectName("structureBPTTInitialReset_CheckBox")
        ...
        self.structureSRNInitialReset_Label = QtWidgets.QLabel(self.basicStructureSRN_Tap)
        self.structureSRNInitialReset_Label.setGeometry(QtCore.QRect(20, 100, 91, 20))
        self.structureSRNInitialReset_Label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.structureSRNInitialReset_Label.setObjectName("structureSRNInitialReset_Label")
        self.structureSRNInitialReset_CheckBox = QtWidgets.QCheckBox(self.basicStructureSRN_Tap)
        self.structureSRNInitialReset_CheckBox.setGeometry(QtCore.QRect(120, 104, 16, 17))
        self.structureSRNInitialReset_CheckBox.setText("")
        ...
        self.layerReset_CheckBox = QtWidgets.QCheckBox(self.customLayer_GroupBox)
        self.layerReset_CheckBox.setGeometry(QtCore.QRect(60, 81, 16, 17))
        self.layerReset_CheckBox.setText("")
        self.layerReset_CheckBox.setChecked(True)
        self.layerReset_CheckBox.setObjectName("layerReset_CheckBox")
        self.layerReset_Label = QtWidgets.QLabel(self.customLayer_GroupBox)
        self.layerReset_Label.setGeometry(QtCore.QRect(10, 80, 40, 16))
        self.layerReset_Label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.layerReset_Label.setObjectName("layerReset_Label")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.structureBPTTInitialReset_Label.setText(_translate("Dialog", "Initial Reset"))
        ...
        self.layerReset_Label.setText(_translate("Dialog", "Reset"))
